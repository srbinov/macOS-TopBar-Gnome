...
import {foregroundForBackground, formatRgba} from './colorUtil.js';
...
export class WindowColorBlend {
    ...
    async _check() {
        ...
        // Translucent, not opaque: the panel should read as tinted liquid glass while a
        // window touches it (see lib/notificationTray.js-adjacent docs/liquid-glass-style.md),
        // not a flat solid tile -- extension.js layers the glass rim/highlight on top of this
        // whenever blendColor is non-null.
        const blendColor = touching ? formatRgba({r, g, b, a: 0.6}) : null;
